...
![Release Candidate](https://img.shields.io/badge/version-v0.9.0--rc.1-blue.svg)
...
> [!IMPORTANT]
> **Release Status:** `v0.9.0-rc.1` — **SOFTWARE RELEASE CANDIDATE — READY FOR REAL HARDWARE VALIDATION**
>
> * **Software Verified:** Web Serial integration, exclusive stream ownership, timeouts, and Content Security Policy (CSP) verified.
> * **Automated-Test Verified:** 34 unit tests in Vitest covering firmware manifest schema validation, 4-byte offset alignment, address overlap detection, flash memory boundary checks, ESP32 image headers, and state transitions.
> * **Build / CI Verified:** Zero TypeScript errors (`tsc -b`), zero oxlint warnings, Vite production bundle generated, and GitHub Actions CI matrix configured for Node 20.x & 22.x.
